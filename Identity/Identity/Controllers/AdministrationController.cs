...
namespace Identity.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> ManageUserClaims(string userId)
        {
            ...
            //create userClaimsViewModel object
            ...
            foreach (var claim in ClaimsStore.GetAllClaims())
            {
                ...
                if (existedUserClaims.Any(c => c.Type == claim.Type))
                {
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel model)
        {
            ...
            if (!result.Succeeded)
            {
                ModelState.AddModelError("", "Can not remove claims from users");
                return View(model);
            }
            ...
            {
                await _userManager.AddClaimsAsync(user, allSelectedClaims);
                if (!result.Succeeded)
                {
